  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex flex-col">
        <h1 className="text-center text-5xl font-bold flex text-[#c8ab6e]">
          <NotebookText size={50} />
          <div>Rules</div>
        </h1>
        <div className="">
          <div className="text-center">World Conquest is a turn-based strategy onchain game. Your mission? To conquer the world!</div>
          <h2 className="text-center text-3xl font-bold my-2 text-[#c8ab6e]">
            Preparation Phase
          </h2>
          <div>At the beginning of the preparation phase, you will receive a certain number of troops depending on the number of players (3 players = 35 troops, 4 players = 30 troops, 5 players = 25 troops & 6 players = 20 troops).
          ...
          <h2 className="text-center text-3xl font-bold mt-4 text-[#c8ab6e]">
            Game Phase
          </h2>
          <div className="mt-2">The game phase of the player whose turn it is (the one with the name in the green box) consists of 3 stages: Reinforcements, Battle and Moving Troops.</div>
          <h3 className="text-2xl font-bold mt-2 text-left text-[#c8ab6e]">
            Reinforcements
          </h3>
          <div>
